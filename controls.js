...
function initControls() {
  ...
  document.addEventListener('keydown', (event) => {
    switch (event.code) {
      ...
      // Pressing Tab should target the nearest enemy or resource
      case 'Tab':
        event.preventDefault(); // prevent browser from focusing next element
        if (window.targetNearest) {
          window.targetNearest();
        }
        break;
    }
  });
